...
export default function PokeCard(props) {
    ...
    async function fetchMoveData(move, moveUrl) {
        ...
        try {
           ...
           const describtion = moveData?.flavor_text_entries.filter
           (val => {
    ...
    useEffect(() => {
        ...
        //2. check if the selected pokemon is in the cache , otherwise fetch fetch from the API
        ...
        //passed all the cache stuff, now we fetch the data from the api
